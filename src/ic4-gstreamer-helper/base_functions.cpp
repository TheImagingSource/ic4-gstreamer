...
bool ic4::gst::helper::is_valid_device_serial (const std::string& serial)
{
    bool ret = false;
...
gst_helper::gst_ptr<GstElement> ic4::gst::helper::open_element (const std::string& element_name)
{
...
ic4::gst::helper::ElementStateGuard::ElementStateGuard(GstElement& element) : p_element(element) {}

ic4::gst::helper::ElementStateGuard::~ElementStateGuard()
{
    gst_element_set_state(&p_element, GST_STATE_NULL);
}

bool ic4::gst::helper::ElementStateGuard::set_state(GstState state)
{
