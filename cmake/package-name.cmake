...
function (create_package_name return_value name version)
  ...
  if(CPACK_DEBIAN_PACKAGE_ARCHITECTURE)
    ...
    if ("${CMAKE_BUILD_TYPE}" STREQUAL "Release")
      ...
      set(build_type "")
    elseif (CPACK_DEBIAN_DEBUGINFO_PACKAGE AND "${CMAKE_BUILD_TYPE}" STREQUAL "RelWithDebInfo")
      # empty since the debug information will be in a separate package
      set(build_type "")
    ...
    if (GIT_TAG)
      ...
      if (GIT_COMMIT_HASH)
        ...
        if ("${GIT_BRANCH}" STREQUAL "master" OR GIT_BRANCH MATCHES "^release-*" OR GIT_BRANCH MATCHES "^release/*")
          set(${return_value}
